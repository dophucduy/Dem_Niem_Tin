...
import { Scale, Users, Shield, ArrowRight, AlertCircle } from "lucide-react";
      ...
      >
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3.5 rounded-xl bg-night-950/80 border border-night-600 focus:border-trust-400 focus:ring-2 focus:ring-trust-400/20 text-white font-mono text-center text-xl font-bold tracking-widest placeholder:text-slate-600 outline-none transition-all"
            required
          />
        </div>
